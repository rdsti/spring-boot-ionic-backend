...
public class CategoriaResources {
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() {
		...
		List<CategoriaDTO> listCategoriaDTO = list.stream().map(obj -> new CategoriaDTO(obj)).collect(Collectors.toList());
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> listCategoriaDTO = list.map(obj -> new CategoriaDTO(obj));
