...
public class DBConfigService {
	...
	public void instantiateTesteDataBase() throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rodrigo.siqueira@rdsti.com.br", "36378912377", TipoCliente.PESSOAFISICA, bcryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "rodrigo.donizete.siqueira@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, bcryptPasswordEncoder.encode("123"));
